export default {
  title: "Rogue",
  content: [
    "New ability: Redirect: Transfers any existing combo points to the current enemy target. 30 sec cooldown. Learned at lvl 30.",
    "New ability: Atrophic Poison: Coats a weapon with poison that lasts for 30 minutes. Each strike has a 30% chance of poisoning the enemy, dealing Nature damage and reducing the enemy's melee attack power for 15 sec. Learned at lvl 60.",
    ...
    "Garrote now also silences the target for 3 seconds.",
