export default {
  title: "Hunter",
  content: [
    "Traps can now be used while in combat, but have a 2 second cast time.",
    "Aspect of the Beast reworked: now also increases the melee attack power of the hunter and the hunter's pet by 10%.",
    "Aspect of the Wild now also icnreases nature damage by 10%.",
