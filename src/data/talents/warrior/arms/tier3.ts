...
const tier3 = [
  ...
  new Talent('Heroic Focus', 'ability_warrior_bullrush', ['Reduces the rage cost of your next two abilities by 100%.'], 1, [[]], null, null, null, null, 'Instant', '2 min cooldown', null, {
    isNew: true,
    isChanged: false,
    isMoved: false,
  }),
