...
const tier2 = [
  ...
  new Talent(
    ...
    ['Increases all resistances by ', ' and causes you to restore ', '% mana after fully resisting or fully absorbing spell damage. 5 sec cooldown.'],
    2,
    [
      [10, 20],
      [2, 4],
  ...
  new Talent(
    ...
    ['When you deal damage with a spell, the next damaging spell of another school you cast within 10 sec deals ', '% increased damage. This effect stacks up to 3 times.'],
    2,
    [[3, 6]],
    null,
    null,
