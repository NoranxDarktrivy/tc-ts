...
const tier5 = [
  new Talent(
    ...
    [
      ...
      "%. In addition, whenever an enemy affected by your Corruption dies or takes damage equal to the Corruption's initial damage, all enemies affected by your Corruption take ",
      'shadow damage.',
    ],
    2,
    [
