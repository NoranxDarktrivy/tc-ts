...
const tier5 = [
  new Talent(
    ...
    ['Reduces the threat generated by your Corruption by ', '%. In addition, increases the damage of your Corruption by ', '% for each additional active corruption, up to 100%.'],
    2,
    [
      [20, 40],
      [10, 20],
