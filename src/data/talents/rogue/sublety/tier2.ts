...
const tier2 = [
  ...
  new Talent('Bloodshed', 'spell_deathknight_bloodboil', ['Your Garrote and Rupture ticks have a ', '% chance to restore 10 energy.'], 2, [[25, 50]], null, null, null, null, null, null, null, {
    isNew: true,
    isChanged: false,
    isMoved: false,
  }),
