...
const tier3 = [
  ...
  new Talent(
    ...
    [
      "The caster is surrounded by 3 globes of water, granting 42 mana per 5 sec. When a spell, melee or ranged attack hits the caster, 39 mana is restored to the caster. This expends one water globe. Only one globe will activate every few seconds. Lasts 10 min. Only one Elemental Shield can be active on the Shaman at any one time.",
    ],
    1,
    [[]],
    null,
