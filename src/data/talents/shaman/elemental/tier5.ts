...
const tier5 = [
  ...
  new Talent(
    ...
    [
      "Your critical strikes offensive spells have a ",
      "% change to add a static charge to the target. Static targets take up to 142 additional Nature damage when they take direct spell damage.",
    ],
    2,
    [[50, 100]],
    null,
