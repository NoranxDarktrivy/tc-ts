...
const tier2 = [
  new Talent(
    ...
    ['Your offensive spell criticals have a ', '% chance to heal a party member within 30 yard range by 70% of the damage dealt. Prioritizes party members with low health.'],
    2,
    [[50, 100]],
    null,
    null,
