...
const tier3 = [
  new Talent(
    ...
    ['Your Power Word: Shield, Heal, Greater Heal, Flash Heal and Renew apply Atonement to your target for 15 sec. Your spell damage heals all targets affected by Atonement for ', '% of the damage done.'],
    2,
    [[15, 30]],
    null,
    null,
